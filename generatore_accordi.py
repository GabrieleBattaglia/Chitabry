# Chitabry, generatore accordi: il motore CSP che trova le diteggiature di un accordo.
# Autori: Gabriele Battaglia (IZ4APU) & ClaudIA (Claude Fable 5.1, UltraCode).
# Revisione 1 del 2026-09-09: le corde si numerano con quelle dello strumento,
# non con le sei della chitarra scritte nel codice.
...
class AccordoSolver:
    ...
    def solve(self, max_stretch=4, tasto_min=0, tasto_max=12):
        ...
        def has_root(*tasti):
            return any(t != -1 and self.model.manico_pc[c, t] == self.root for c, t in enumerate(tasti))
    ...
    def analizza_difficolta_e_diteggiatura(self, soluzione: dict, score: int) -> dict:
        ...
        for i in range(self.model.num_corde):
            ...
            if desc not in dita_desc:
                dita_desc[desc] = []
            corda_std = str(self.model.num_corde - i)  # Da 0..n-1 a n..1
