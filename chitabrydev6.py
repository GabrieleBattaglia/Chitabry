# Chitabry - DEV6 - Studio sulla Chitarra e sulla teoria musicale - di Gabriele Battaglia e Gemini 2.5 Pro
...
# --- Costanti ---
VERSIONE = "4.6.0 del 5 novembre 2025."
...
class NoteRenderer:
    ...
    def _render_karplus_strong(self, n_samples):
        ...
        pluck = _generate_filtered_pluck_burst(N, self.fs, self.pluck_hardness)
        buf = deque(pluck)
